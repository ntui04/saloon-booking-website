...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name) || empty($description) || empty($price) || empty($duration) || empty($category)) {
        ...
        $stmt = execute_query("
            UPDATE services 
            SET name = ?, description = ?, price = ?, duration = ?, category = ?, image_url = ?, is_active = ?
            WHERE id = ?
        ", [$name, $description, $price, $duration, $category, $image_url, $is_active, $service_id]);
...
<head>
    ...
    <title>Edit Service - <?php echo SITE_NAME; ?></title>
    ...
    <div class="admin-layout">
        ...
        <main class="main-content">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                <h1 style="color: var(--foreground); margin: 0;">Edit Service</h1>
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select id="category" name="category" class="form-control" required>
                            ...
                            <option value="Hair" <?php echo $service['category'] == 'Hair' ? 'selected' : ''; ?>>Hair</option>
                            <option value="Nails" <?php echo $service['category'] == 'Nails' ? 'selected' : ''; ?>>Nails</option>
                            <option value="Skincare" <?php echo $service['category'] == 'Skincare' ? 'selected' : ''; ?>>Skincare</option>
                            <option value="Beauty" <?php echo $service['category'] == 'Beauty' ? 'selected' : ''; ?>>Beauty</option>
                            <option value="Massage" <?php echo $service['category'] == 'Massage' ? 'selected' : ''; ?>>Massage</option>
                        </select>
                    </div>
                    ...
                    <?php if ($service['image_url']): ?>
                        <div class="form-group">
                            ...
                            <img src="<?php echo htmlspecialchars($service['image_url']); ?>" 
                                 alt="Current service image" class="current-image">
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group">
                        <label for="image" class="form-label">Or Upload New Image (Optional)</label>
                    ...
                    <div class="form-group">
                        <div class="checkbox-group">
                            ...
                            <label for="is_active" class="form-label" style="margin-bottom: 0;">Service is active</label>
                        </div>
                    </div>
